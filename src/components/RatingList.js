    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {ratings.length === 0 ? (
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <h3 className="mt-2 text-lg font-medium text-gray-900">Nenhuma avaliação encontrada</h3>
          <p className="mt-1 text-gray-500">Você ainda não avaliou nenhum curso.</p>
          <div className="mt-6">
          </div>
        </div>
      ) : (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6 flex justify-between">
                    ...
                    <button
                      onClick={() => handledeleteRating(coupon.id)}
