    ...
    <div class="app-container">
        ...
        <main>
            ...
            <div class="filter-buttons">
                ...
                <button>Avaliados</button>
                <button>Plataforma</button>
                 <button>Preço</button> </div>
            <div class="course-grid">
                <div class="course-card">
                    <img src="https://via.placeholder.com/150x80.png?text=Python" alt="Python Course">
                    <h3>Python Completo</h3>
                     <p class="platform-tag">Udemy</p>
                    <div class="rating">
                 ...
                 <div class="course-card">
                    <img src="https://via.placeholder.com/150x80.png?text=CSS" alt="CSS Course">
                    <h3>CSS Avançado</h3>
                     <p class="platform-tag">Coursera</p>
                    <div class="rating">
                 ...
                 <div class="course-card">
                    <img src="https://via.placeholder.com/150x80.png?text=IA" alt="AI Course">
                    <h3>Inteligência Artificial</h3>
                     <p class="platform-tag">Alura</p>
                    <div class="rating">
                ...
                <div class="course-card">
                    <img src="https://via.placeholder.com/150x80.png?text=AWS" alt="AWS Course">
                 ...
                 <div class="course-card">
                    <img src="https://via.placeholder.com/150x80.png?text=React" alt="React Course">
                    <h3>React Essencial</h3>
                     <p class="platform-tag">Domestika</p>
                     <div class="rating">
                 ...
                 <div class="course-card">
                    <img src="https://via.placeholder.com/150x80.png?text=Node.js" alt="Node Course">
...
/* --- Existing CSS from the previous answer goes here --- */
/* Make sure to rename .mobile-screen to .app-container in the base styles */
/* Example: */
/* .mobile-screen { ... } becomes: */
.app-container {
