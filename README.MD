...
| **Manutenção de Cupons**    | X                |  X             |
| **Manutenção de Avaliação** | X                  | X             |

### Explicação da Matriz Perfil x Funcionalidade
- **Manutenção de Cursos**: O **Usuário Consumidor** adiciona e gerencia cursos, e o **Administrador** tem acesso para supervisão. O **Moderador** não precisa dessa funcionalidade, pois sua função é focada em avaliações.
- **Manutenção de Cupons**: O **Usuário Consumidor** gerencia seus cupons, e o **Administrador** tem acesso para suporte. O **Moderador** não precisa dessa funcionalidade, pois cupons são pessoais e não requerem moderação.
- **Manutenção de Avaliação**: O **Usuário Consumidor** cria e visualiza avaliações, o **Moderador** modera (edita ou remove avaliações inadequadas), e o **Administrador** tem acesso total para gerenciamento e suporte.
